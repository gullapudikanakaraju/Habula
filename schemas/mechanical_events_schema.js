...
var mechanical_events_schema = new Schema({
	_id :{
        type : Number,
...
var mechanical_events_model = connec.model('mechanical_event', mechanical_events_schema);
module.exports = mechanical_events_model;