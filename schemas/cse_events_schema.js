...
// autoIncrement.initialize(connec);
var cse_events_schema = new Schema({
	_id :{
        type : Number,
        required : true,
        unique : true,
...
// cse_events_schema.plugin(autoIncrement.plugin, {model:'cse_event', field:'post_number', startAt:1});
var cse_events_model = connec.model('cse_event', cse_events_schema);
module.exports = cse_events_model;